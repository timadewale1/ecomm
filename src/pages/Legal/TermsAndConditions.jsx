        ...
        <div className="w-full max-w-3xl bg-white rounded-lg shadow-md">
          ...
          <div className="px-3">
            <p className="text-xs text-gray mb-3 mt-3">
              ©2024 My Thrift Clothing. Ltd, ALL RIGHTS RESERVED. Kindly refer
              to the legal notice below for our Terms and Conditions.
            </p>
          ...
          <div className="space-y-6 text-sm py-6 px-3">
            ...
            <section id="1" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                ...
                Thrift. Ltd, and “you,” “your,” or “user/s” shall collectively
                or respectively refer to vendors and buyers).
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">1.3</span> By using our
                platform, you fully agree to our general terms and conditions.
                Any disagreement thereof shall amount to your immediate disuse
                of our platform.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">1.4</span> We reserve the
                right to update or modify our terms of use, including our
                Privacy Policy, at any point in time. Notices of such changes
                will be provided by any reasonable means we deem fit or at our
                sole discretion.
              </p>
            </section>
            ...
            <section id="2" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                ...
                least 18 years of age to create an account or be registered on
                our platform. By agreeing to our terms and conditions and using
                our platform, you represent that you are of the age stipulated.
              </p>
              <p className="leading-relaxed text-black">
              ...
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">2.3</span> You represent
                that all information provided in the registration form is
                credible and accurate.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">2.4</span> You are
                responsible for maintaining the confidentiality of your account
                and password and restricting access to your computer, and this
                requires that;
              </p>
              <ul className="list-disc leading-relaxed space-y-2 mt-2">
                <li className="flex w-full">
                  ...
                  <p className="text-black">
                    You agree to accept responsibility for all the activities
                    that occur under your account or password to the extent
                ...
                <li className="flex w-full">
                  ...
                  <p className="text-black">
                    ...
                    that your password or account has been compromised or
                ...
                <li className="flex w-full">
                  ...
                  <p className="text-black">
                    ...
                    party. Any complications or issues that arise from a
                    voluntary third-party account transfer shall be at your own
                    risk.
                  </p>
                </li>
              </ul>
              ...
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">2.6</span> You may cancel
                your account on our platform at any point in time, provided you
            ...
            <section id="3" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">3.1</span> Vendors are
              ...
              <p className="leading-relaxed text-black">
                ...
                the right to modify provisions in this regard at a later date.
              </p>
              <p className="leading-relaxed text-black">
              ...
              <p className="leading-relaxed text-black">
                ...
                service fee charges are capped so no need to worry about
                excessive charges.
              </p>
            </section>
            ...
            <section id="4" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                ...
                third-party sellers or vendors to list and sell their products
                on our e-commerce platform. Our role is none other than that of
                a compensated transaction facilitator. To explain further, we
                are neither the buyer nor seller of the products displayed on
                our platform.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">4.3</span> My Thrift
                provides a platform for buyers and sellers to negotiate and
                conclude transactions. The contract formed at the completion of
                the sale of third-party products is, therefore, solely between
                the buyer and seller.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">4.3</span> My Thrift shall
                assist sellers in connecting with buyers in order to facilitate
                or conclude transactions. Registered sellers are allowed to
                contact registered buyers outside the platform with the sole
                purpose of concluding sales.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">4.4</span> Buyer or customer
                information will be shared with vendors or sellers on our
                platform in line with provision 4.3.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">4.5</span> Vendors are
                allowed to cancel or decline customer orders if products are
                later found to be out of stock or unavailable.
              </p>
              <p className="leading-relaxed text-black">
                ...
                resolved using the chatbox or any means of communication
                provided on the platform. We assume no responsibility for such
                disputes.
              </p>
              <p className="leading-relaxed text-black">
              ...
              <ul className="list-disc leading-relaxed space-y-2 mt-2">
                ...
                <li className="flex w-full">
                  ...
                  <p className="text-black">
                    The seller represents and warrants that he/she has good
                    title to the goods sold and is the sole beneficial or legal
                    owner.
                  </p>
                </li>
              </ul>
            ...
            <section id="5" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                ...
                logistics of goods shall be facilitated by vendors either
                through third-party agents or by vendors themselves.
              </p>
              <p className="leading-relaxed text-black">
              ...
              <p className="leading-relaxed text-black">
                ...
                or take responsibility for unfulfilled deliveries once
                complaints have been vetted and found to be untenable
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">5.4</span> Vendors are
                liable to get their accounts deactivated, restricted, or deleted
                if found guilty of marking an order fulfilled when, in fact, the
                order is yet to be dispatched or sent out for delivery, and no
                confirmation from the logistics company in this regard was
                requested.
              </p>
              <p className="leading-relaxed text-black">
            ...
            <section id="6" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">6.1</span> Vendors on My
                Thrift maintain their own individual refund policies, which
                generally take precedence. Customers are encouraged to review
                each vendor's refund and return policies prior to making a
                purchase.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">6.2</span> Notwithstanding
                vendor-specific policies, My Thrift reserves the right to
                intervene and facilitate a refund or return if an item delivered
                is significantly damaged, materially different from what was
                explicitly advertised, or in clear cases of vendor
                misrepresentation. Such cases will be thoroughly reviewed by My
                Thrift before a refund or return is processed.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">6.3</span> My Thrift will
                not authorize refunds or returns in instances where the buyer
                mistakenly selected the wrong color, size, or variation of a
                product. Refunds and returns under these circumstances remain
                solely at the vendor’s discretion.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">6.4</span> If an order is
                declined or canceled by a registered vendor after payment
                confirmation, My Thrift shall facilitate the refund to the
                customers wallet.{" "}
              </p>
            </section>
            ...
            <section id="7" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                ...
                use, translate, store, adapt, publish, and distribute content
                you provide across all our marketing channels, either in
                existence or to be created at a future date.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">7.3</span> Your moral rights
                in your content are hereby waived to the fullest extent
            ...
            <section id="8" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">8.2</span> We do not
                undertake to provide satisfactory quality products or sales
                items and any other warranty of such nature, whether express or
                implied.
              </p>
              <p className="leading-relaxed text-black">
                ...
                misrepresentation or negligence or any other liability that
                cannot be limited or excluded by law.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">8.4</span> We will not be
                held liable for any exemplary, incidental, punitive, or special
                damage arising from your inability to access or use our
                platform.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">8.5</span> We will not be
                held liable for any damage you incur from using or tampering
                with our platform or services in an unauthorized manner.
              </p>
            </section>
            ...
            <section id="9" className="pt-4 scroll-mt-14 space-y-3">
              ...
              <p className="leading-relaxed text-black">
                The terms and conditions of our platform are governed by the
                laws of Nigeria. Any dispute that may arise regarding the
                interpretation, validity, and/or execution of these terms will
                be settled or resolved under the exclusive jurisdiction of the
                Nigerian courts.
              </p>
            </section>
            <section id="10" className="pt-4 scroll-mt-14 space-y-3">
              <h3 className="text-lg font-semibold text-customOrange mb-2">
                10. Stockpile Policy
              </h3>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">10.1</span> Customers are
                free to stockpile items within the vendor-specified timeframe.
                During stockpiling, vendors receive 100% of the order value.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">10.2</span> My Thrift
                provides buyer protection for stockpile orders through a buyer
                protection fee. If a stockpiled order is not delivered or items
                are missing, customers may be eligible for a refund after
                verification by My Thrift.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">10.3</span> Customers may
                repile and add products to their stockpile multiple times
                without incurring additional service fees or buyer protection
                fees. Customers can request shipping at any time after creating
                a stockpile.
              </p>
              <p className="leading-relaxed text-black">
                <span className="text-customOrange">10.4</span> The buyer
                protection fee is set at a base of ₦1,200. For stockpiles
                exceeding ₦20,000, the buyer protection fee increases by 5% for
                every additional ₦10,000 increment.
              </p>
            </section>
          </div>
        </div>
