...
const MultiDiscountModal = ({ isOpen, onRequestClose, product }) => {
  ...
  return (
    <>
      ...
      <ConfirmationDialog
            ...
            // onConfirm={handleBulkDiscountAddition}
            message="Are you sure you want to add this discount to the selected product(s)?"
            icon = {<TbRosetteDiscount className="w-4 h-4" />}
            title="Add Discount"
            // loading={oLoading}
          />
      </div>
...
export default MultiDiscountModal;
