...
const OnlineVendors = () => {
  ...
  const handleRatingChange = async (vendorId, newRating) => {
    const vendorRef = doc(db, "vendors", vendorId);
    const ratingCollectionRef = collection(db, "vendors", vendorId, "ratings");

    await addDoc(ratingCollectionRef, { rating: newRating });
    ...
    setVendors(vendors.map(vendor => vendor.id === vendorId ? { ...vendor, rating: averageRating, ratingCount: ratings.length } : vendor));
  };
                  ...
                  <div>
                    ...
                    <div className="flex items-center translate-y-4">
                      ...
                      <ReactStars
                        ...
                        onChange={(newRating) => handleRatingChange(vendor.id, newRating)}
                      />
