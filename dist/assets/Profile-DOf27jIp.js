...
import { m as fa } from "./cartMerge-BMaHK3Vz.js";
import { h as ha, g as pa } from "./index-DV9LhBdq.js";
import "./react-DNBAOpZC.js";
import { P as ma } from "./Productnotofund-sGMAt8nV.js";
import { U as ua, C as xa } from "./user-B4AW-n1L.js";
const va = (a) => ({ type: "SET_USER_DATA", payload: a }),
  Za = (a) => ({ type: "UPDATE_USER_DATA", payload: a });
function Ma(a) {
  return a
    .replace(/&/g, "&amp;")
    .replace(/'/g, "&apos;")
  ...
  let c =
    (function (a) {
      ...
      for (let l = 0; l < a.length; l++)
        ((c = ((c << 5) - c + a.charCodeAt(l)) | 0), (c = ba(c)));
      return c;
    })((a = a.toString())) || 1;
  const l = () => (c = ba(c)),
    t = (a, c) => Math.floor(((l() - ga) / 4294967295) * (c + 1 - a) + a);
  return {
    seed: a,
    next: l,
    bool: (a = 50) => t(1, 100) <= a,
    ...
    pick(a, c) {
      ...
      return 0 === a.length
        ? (l(), c)
        : null !== (e = a[t(0, a.length - 1)]) && void 0 !== e
          ? e
          : c;
    },
    shuffle(a) {
      const c = ya(l().toString()),
        t = [...a];
      for (let l = t.length - 1; l > 0; l--) {
        const a = c.integer(0, l);
        [t[l], t[a]] = [t[a], t[l]];
      }
      return t;
    },
    string(a, c = "abcdefghijklmnopqrstuvwxyz1234567890") {
      const t = ya(l().toString());
      let e = "";
      for (let l = 0; l < a; l++) e += c[t.integer(0, c.length - 1)];
      return e;
    },
  };
}
function Aa(a) {
  let c = a.attributes.viewBox.split(" ");
  return {
    x: parseInt(c[0]),
    y: parseInt(c[1]),
    width: parseInt(c[2]),
...
const ja = {
  properties: {
    ...
    backgroundType: {
      type: "array",
      items: { type: "string", enum: ["solid", "gradientLinear"] },
      default: ["solid"],
    },
    backgroundRotation: {
      type: "array",
    ...
    clip: { type: "boolean", default: !0 },
    randomizeIds: { type: "boolean", default: !1 },
  },
};
function wa(a) {
  var c;
  let l = {},
    t = null !== (c = a.properties) && void 0 !== c ? c : {};
  return (
...
function $a(a, c = {}) {
  ...
  c = (function (a, c) {
    ...
    let t = {
      ...wa(ja),
      ...wa(null !== (l = a.schema) && void 0 !== l ? l : {}),
      ...c,
    };
    return JSON.parse(JSON.stringify(t));
  })(a, c);
  const i = ya(c.seed),
    n = a.create({ prng: i, options: c }),
    o = i.pick(
      null !== (l = c.backgroundType) && void 0 !== l ? l : [],
      "solid",
    ),
    { primary: d, secondary: f } = (function (a, c, l) {
      var t;
      let e = a.shuffle(c);
      (e.length <= 1 || (2 == c.length && "gradientLinear" == l)
        ? ((e = c), a.next())
        : (e = a.shuffle(c)),
        0 === e.length && (e = ["transparent"]));
      const s = e[0],
        r = null !== (t = e[1]) && void 0 !== t ? t : e[0];
      return { primary: Na(s), secondary: Na(r) };
    })(i, null !== (t = c.backgroundColor) && void 0 !== t ? t : [], o),
    h = i.integer(
      (null === (e = c.backgroundRotation) || void 0 === e ? void 0 : e.length)
        ? Math.min(...c.backgroundRotation)
        : 0,
      (null === (s = c.backgroundRotation) || void 0 === s ? void 0 : s.length)
        ? Math.max(...c.backgroundRotation)
        : 0,
    );
  (c.size &&
    ((n.attributes.width = c.size.toString()),
    (n.attributes.height = c.size.toString())),
    void 0 !== c.scale &&
      100 !== c.scale &&
      (n.body = (function (a, c) {
        let { width: l, height: t, x: e, y: s } = Aa(a),
          r = c ? (c - 100) / 100 : 0;
        return `<g transform="translate(${(l / 2 + e) * r * -1} ${(t / 2 + s) * r * -1}) scale(${c / 100})">${a.body}</g>`;
      })(n, c.scale)),
    c.flip &&
      (n.body = (function (a) {
        let { width: c, x: l } = Aa(a);
        return `<g transform="scale(-1 1) translate(${-1 * c - 2 * l} 0)">${a.body}</g>`;
      })(n)),
    c.rotate &&
      (n.body = (function (a, c) {
        let { width: l, height: t, x: e, y: s } = Aa(a);
        return `<g transform="rotate(${c}, ${l / 2 + e}, ${t / 2 + s})">${a.body}</g>`;
      })(n, c.rotate)),
    (c.translateX || c.translateY) &&
      (n.body = (function (a, c, l) {
        let t = Aa(a);
        return `<g transform="translate(${(t.width + 2 * t.x) * ((null != c ? c : 0) / 100)} ${(t.height + 2 * t.y) * ((null != l ? l : 0) / 100)})">${a.body}</g>`;
      })(n, c.translateX, c.translateY)),
    "transparent" !== d &&
      "transparent" !== f &&
      (n.body = (function (a, c, l, t, e) {
        let { width: s, height: r, x: i, y: n } = Aa(a);
        const o = `<rect fill="${c}" width="${s}" height="${r}" x="${i}" y="${n}" />`;
        switch (t) {
          case "solid":
            return o + a.body;
          case "gradientLinear":
            return (
              `<rect fill="url(#backgroundLinear)" width="${s}" height="${r}" x="${i}" y="${n}" /><defs><linearGradient id="backgroundLinear" gradientTransform="rotate(${e} 0.5 0.5)"><stop stop-color="${c}"/><stop offset="1" stop-color="${l}"/></linearGradient></defs>` +
              a.body
            );
        }
      })(n, d, f, o, h)),
    (c.radius || c.clip) &&
      (n.body = (function (a, c) {
        let { width: l, height: t, x: e, y: s } = Aa(a);
        return `<mask id="viewboxMask"><rect width="${l}" height="${t}" rx="${c ? (l * c) / 100 : 0}" ry="${c ? (t * c) / 100 : 0}" x="${e}" y="${s}" fill="#fff" /></mask><g mask="url(#viewboxMask)">${a.body}</g>`;
      })(n, null !== (r = c.radius) && void 0 !== r ? r : 0)),
    c.randomizeIds &&
      (n.body = (function (a) {
        const c = ya(Math.random().toString()),
          l = {};
        return a.body.replace(
          /(id="|url\(#)([a-z0-9-_]+)([")])/gi,
          (a, t, e, s) => ((l[e] = l[e] || c.string(8)), `${t}${l[e]}${s}`),
        );
      })(n)));
  const p = (function (a) {
      const c = { xmlns: "http://www.w3.org/2000/svg", ...a.attributes };
    ...
    m = (function (a) {
      var c, l, t, e, s, r, i;
      const n = null === (c = a.meta) || void 0 === c ? void 0 : c.title,
        o = null === (l = a.meta) || void 0 === l ? void 0 : l.creator,
        d = null === (t = a.meta) || void 0 === t ? void 0 : t.source,
        f =
          null ===
            (s = null === (e = a.meta) || void 0 === e ? void 0 : e.license) ||
          void 0 === s
            ? void 0
            : s.url,
        h = (function (a) {
          var c, l, t, e, s, r, i, n, o, d, f, h, p, m, u;
          let x = (null === (c = a.meta) || void 0 === c ? void 0 : c.title)
              ? `„${null === (l = a.meta) || void 0 === l ? void 0 : l.title}”`
              : "Design",
            v = `„${null !== (e = null === (t = a.meta) || void 0 === t ? void 0 : t.creator) && void 0 !== e ? e : "Unknown"}”`;
          (null === (s = a.meta) || void 0 === s ? void 0 : s.source) &&
            (x += ` (${a.meta.source})`);
          let Z = "";
          return (
            "MIT" !==
              (null ===
                (i =
                  null === (r = a.meta) || void 0 === r ? void 0 : r.license) ||
              void 0 === i
                ? void 0
                : i.name) &&
              "DiceBear" !==
                (null === (n = a.meta) || void 0 === n ? void 0 : n.creator) &&
              (null === (o = a.meta) || void 0 === o ? void 0 : o.title) &&
              (Z += "Remix of "),
            (Z += `${x} by ${v}`),
            (null ===
              (f =
                null === (d = a.meta) || void 0 === d ? void 0 : d.license) ||
            void 0 === f
              ? void 0
              : f.name) &&
              ((Z += `, licensed under „${null === (p = null === (h = a.meta) || void 0 === h ? void 0 : h.license) || void 0 === p ? void 0 : p.name}”`),
              (null ===
                (u =
                  null === (m = a.meta) || void 0 === m ? void 0 : m.license) ||
              void 0 === u
                ? void 0
                : u.url) && (Z += ` (${a.meta.license.url})`)),
            Z
          );
        })(a);
      return n || o || d || f || h
        ? '<metadata xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/"><rdf:RDF><rdf:Description>' +
            (n ? `<dc:title>${Ma(n)}</dc:title>` : "") +
            (o ? `<dc:creator>${Ma(o)}</dc:creator>` : "") +
            (d
              ? `<dc:source xsi:type="dcterms:URI">${Ma(null !== (i = null === (r = a.meta) || void 0 === r ? void 0 : r.source) && void 0 !== i ? i : "")}</dc:source>`
              : "") +
            (f
              ? `<dcterms:license xsi:type="dcterms:URI">${Ma(f)}</dcterms:license>`
              : "") +
            (h ? `<dc:rights>${Ma(h)}</dc:rights>` : "") +
            "</rdf:Description></rdf:RDF></metadata>"
        : "";
    })(a),
    u = `<svg ${p}>${m}${n.body}</svg>`;
  return {
    toString: () => u,
    toJson: () => {
      var a;
...
function Sa({ prng: a, group: c, values: l = [] }) {
  const t = Ea,
    e = a.pick(l);
  return e && t[c][e] ? { name: e, value: t[c][e] } : void 0;
}
function za(a) {
  return "transparent" === a ? a : `#${a}`;
}
const Da = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        create: ({ prng: a, options: c }) => {
          var l, t, e, s, r, i, n, o, d, f, h, p, m, u, x, v;
          const Z = (function ({ prng: a, options: c }) {
              const l = Sa({ prng: a, group: "base", values: c.base }),
                t = Sa({ prng: a, group: "eyes", values: c.eyes }),
                e = Sa({ prng: a, group: "eyebrows", values: c.eyebrows }),
                s = Sa({ prng: a, group: "mouth", values: c.mouth }),
                r = Sa({ prng: a, group: "features", values: c.features }),
                i = Sa({ prng: a, group: "glasses", values: c.glasses }),
                n = Sa({ prng: a, group: "hair", values: c.hair }),
                o = Sa({ prng: a, group: "earrings", values: c.earrings });
              return {
                base: l,
                eyes: t,
                eyebrows: e,
                mouth: s,
                features: a.bool(c.featuresProbability) ? r : void 0,
                glasses: a.bool(c.glassesProbability) ? i : void 0,
                hair: a.bool(c.hairProbability) ? n : void 0,
                earrings: a.bool(c.earringsProbability) ? o : void 0,
              };
            })({ prng: a, options: c }),
            M = (function ({ prng: a, options: c }) {
              var l, t;
              return {
                skin: za(
                  a.pick(
                    null !== (l = c.skinColor) && void 0 !== l ? l : [],
                    "transparent",
                  ),
                ),
                hair: za(
                  a.pick(
                    null !== (t = c.hairColor) && void 0 !== t ? t : [],
                    "transparent",
                  ),
                ),
              };
          ...
          return (
            (function ({ prng: a, options: c, components: l, colors: t }) {
              var e;
              (null === (e = l.hair) || void 0 === e ? void 0 : e.name) &&
                [
                  "long01",
                  "long04",
                  "long05",
                  ...
                  "long24",
                  "long26",
                ].includes(l.hair.name) &&
                (l.earrings = void 0);
            })({ prng: a, options: c, components: Z, colors: M }),
            {
              attributes: {
                viewBox: "0 0 762 762",
                fill: "none",
              ...
              body: `${null !== (t = null === (l = Z.base) || void 0 === l ? void 0 : l.value(Z, M)) && void 0 !== t ? t : ""}<g transform="translate(-161 -83)">${null !== (s = null === (e = Z.eyes) || void 0 === e ? void 0 : e.value(Z, M)) && void 0 !== s ? s : ""}</g><g transform="translate(-161 -83)">${null !== (i = null === (r = Z.eyebrows) || void 0 === r ? void 0 : r.value(Z, M)) && void 0 !== i ? i : ""}</g><g transform="translate(-161 -83)">${null !== (o = null === (n = Z.mouth) || void 0 === n ? void 0 : n.value(Z, M)) && void 0 !== o ? o : ""}</g><g transform="translate(-161 -83)">${null !== (f = null === (d = Z.features) || void 0 === d ? void 0 : d.value(Z, M)) && void 0 !== f ? f : ""}</g><g transform="translate(-161 -83)">${null !== (p = null === (h = Z.glasses) || void 0 === h ? void 0 : h.value(Z, M)) && void 0 !== p ? p : ""}</g><g transform="translate(-161 -83)">${null !== (u = null === (m = Z.hair) || void 0 === m ? void 0 : m.value(Z, M)) && void 0 !== u ? u : ""}</g><g transform="translate(-161 -83)">${null !== (v = null === (x = Z.earrings) || void 0 === x ? void 0 : x.value(Z, M)) && void 0 !== v ? v : ""}</g>`,
              extra: () => ({
                ...Object.entries(Z).reduce(
                  (a, [c, l]) => ((a[c] = null == l ? void 0 : l.name), a),
                  {},
                ),
  ...
  Ua = ({ userId: p, onClose: m, onAvatarChange: u, onRemoveAvatar: x }) => {
    const [v, Z] = a.useState(null),
      [M, g] = a.useState(null),
      [b, y] = a.useState(null),
      [A, j] = a.useState(null),
      [w, N] = a.useState(!1),
      [$, k] = a.useState(!1),
      C = a.useRef(null),
      E = c((a) => a.user.userData);
    a.useEffect(() => {
      if (E && E.photoURL) {
        Z(E.photoURL);
        const a = S(E.photoURL);
        j(a);
      } else (Z(null), j(null));
    }, [E]);
    const S = (a) => {
    ...
    return l.jsx("div", {
      className:
        "fixed inset-0 modal flex items-center justify-center bg-black bg-opacity-50 z-50",
      children: l.jsxs("div", {
        className: "bg-white  rounded-lg  w-full h-full relative font-opensans",
        children: [
          l.jsx(t, {
            className:
              "absolute text-xl top-4 right-4 z-20 text-black cursor-pointer",
            onClick: m,
          }),
          l.jsx("div", {
            className: "flex items-center p2 justify-center ",
            children: v
              ? l.jsxs("div", {
                  ...
                  children: [
                    ...
                    A &&
                      l.jsx("div", {
                        className:
                          "absolute font-ubuntu font-semibold top-2 left-1/2 transform -translate-x-1/2 bg-white bg-opacity-60 px-4 py-1 rounded-full text-sm text-black",
                        children: A,
                      }),
                  ],
                })
              : l.jsx("div", {
                  className:
                    "w-full h-96  bg-gray-200 flex items-center justify-center",
                  children: l.jsx("p", {
          ...
          l.jsxs("div", {
            className: "flex overflow-x-auto -translate-y-8 gap-4 px-4 py-2",
            children: [
              l.jsx("div", {
                className:
                  "flex-shrink-0 bg-customCream  cursor-pointer w-20 h-20 rounded-lg border-4 \r\n                       border-white hover:border-green-400 transition-colors \r\n                       flex items-center justify-center",
                onClick: () => {
                  var a;
                  null == (a = C.current) || a.click();
                },
                children: b
                  ? l.jsx("img", {
                      src: b,
                  ...
                  : l.jsx(ha, { className: "text-customBrown text-5xl" }),
              }),
              Pa.map((a) => {
                const c = z(a);
                return l.jsx(
                  ...
                  {
                    className:
                      "flex-shrink-0 cursor-pointer w-20 h-20 rounded-lg overflow-hidden \n                            border-4 border-white hover:border-green-400 transition-colors\n                            flex items-center justify-center " +
                      (v === c ? "border-green-500" : ""),
                    onClick: () =>
                      ((a, c) => {
                        (g(null), y(null), j(c), Z(a));
                      })(c, a),
                    children: l.jsx("img", {
                      src: c,
                      alt: a,
          ...
          l.jsxs("div", {
            className:
              " p-6 flex flex-col mt-6 justify-between items-center bg-white w-full",
            children: [
              l.jsx("button", {
                onClick: async () => {
                  k(!0);
                  try {
                    ...
                    s.error("Error removing avatar. Please try again.", {
                      className: "custom-toast",
                    });
                  } finally {
                    k(!1);
                ...
                className:
                  "border border-customBrown text-red-600 text-sm font-semibold w-80 h-12  mb-4 px-4 rounded-lg flex items-center justify-center",
                disabled: $,
                children: $
                  ? l.jsx(e, {
                      strokeColor: "red",
              ...
              l.jsx("button", {
                onClick: async () => {
                  if (v) {
                    ...
                    try {
                      if (null == M && null == b)
                        (await r(i(n, "users", p), { photoURL: v }),
                          u && u(v),
                          s.success("Avatar updated successfully", {
                            className: "custom-toast",
                          }),
                          m());
                      else if (M) {
                        const a = o(d, `avatars/${p}/${M.name}`);
                        await f(a, M);
                        const c = await h(a);
                        (await r(i(n, "users", p), { photoURL: c }),
                          u && u(c),
                          s.success("Profile picture updated successfully", {
                            className: "custom-toast",
                          }),
                          m());
                      }
                    } catch (a) {
                      s.error("Error updating avatar. Please try again.", {
                        className: "custom-toast",
                      });
                    } finally {
                      N(!1);
                    ...
                    s.error("Please select an avatar first.", {
                      className: "custom-toast",
                    });
                },
                className:
                  "bg-customOrange text-white w-80 h-12 text-sm font-semibold font-opensans px-4 rounded-lg flex items-center justify-center",
                disabled: w,
                children: w
                  ? l.jsx(e, {
                      strokeColor: "white",
  ...
  Ra = ({ currentUser: t, setShowDetails: o }) => {
    const [d, f] = a.useState(!0),
      [h, F] = a.useState(!1),
      L = p(),
      G = c((a) => a.user.userData),
      [_, O] = a.useState({ lat: null, lng: null }),
      [T, I] = a.useState(!1),
      B = a.useRef(null),
      [W, J] = a.useState(""),
      [V, q] = a.useState(""),
    ...
    if (
      ...
      a.useEffect(() => {
        if ("address" !== W || !T) return;
        const a = document.getElementById("autocomplete"),
          c = new google.maps.places.Autocomplete(a),
          l = { lat: 6.5244, lng: 3.3792 };
        let t, e;
        (c.addListener("place_changed", () => {
          const a = c.getPlace();
          if (!a.geometry) return;
          const l = a.geometry.location;
          (O({ lat: l.lat(), lng: l.lng() }),
            ra(a.formatted_address),
            t && e.setPosition(l),
            t && t.setCenter(l));
        }),
          (t = new google.maps.Map(B.current, { center: l, zoom: 13 })),
          (e = new google.maps.Marker({ map: t, position: l, draggable: !0 })),
          e.addListener("dragend", (a) => {
            O({ lat: a.latLng.lat(), lng: a.latLng.lng() });
          }));
      }, [W, T]),
      d)
    )
      return l.jsx(x, {});
    const fa = (a = "") => String(a).trim().split(/\s+/).filter(Boolean);
    if (!t)
      return l.jsxs("div", {
        ...
        children: [
          l.jsx("div", {
            className:
              "sticky top-0 bg-white z-10 flex items-center -translate-y-4 justify-between h-24 w-full",
            children: l.jsxs("div", {
              ...
              children: [
                ...
                l.jsx("h1", {
                  className: "text-xl font-medium font-opensans text-black   ",
          ...
          l.jsxs("div", {
            className: "px-20 flex-col flex justify-center items-center",
            children: [
              l.jsx(ma, {}),
              l.jsx("p", {
                className:
                  "text-center text-sm text-gray-800 font-opensans mb-4",
                children:
                  "Oops! You cannot view profile details at the moment because no user is logged in.",
              }),
              l.jsx("button", {
                className:
                  "bg-customOrange font-opensans text-white px-4 py-2 rounded-full",
                onClick: () => {
                  oa("/login", { state: { from: da.pathname } });
                },
                children: "Login",
              }),
            ],
    ...
    const ha = (a) => {
        if ((J(a), "displayName" === a)) {
          const a = fa(H);
          (Q(a[0] || ""), aa(a.slice(1).join(" ") || ""));
        }
        F(!0);
      },
      pa = (a) => a.charAt(0).toUpperCase() + a.slice(1).toLowerCase();
    return l.jsxs("div", {
      className: "flex flex-col w-full h-full p-2 items-center",
      children: [
        l.jsx("div", {
          className:
            "sticky top-0 bg-white z-10 flex items-center -translate-y-4 justify-between h-24 w-full",
        ...
        l.jsxs("div", {
          ...
          children: [
            l.jsxs("div", {
              className:
                "flex flex-col border-none rounded-xl bg-customGrey mb-2 items-center w-full ",
              children: [
                l.jsx("h1", {
                  className:
                    "text-xs w-full font-opensans translate-y-3 translate-x-6 font-medium text-gray-500",
                  children: "UserName",
                }),
                l.jsxs("div", {
                  className:
                  ...
                  children: [
                    l.jsx(Z, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-normal font-opensans text-black w-full",
                      children: V || "Username",
                    }),
                    l.jsx(M, {
                      className:
                        (V ? "text-green-500" : "text-yellow-500") +
                        " text-2xl ml-2",
                    }),
                    l.jsx(g, {
              ...
              children: [
                ...
                l.jsxs("div", {
                  className:
                    "flex items-center justify-between w-full px-4 py-3",
                  children: [
                    l.jsx(b, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-normal font-opensans text-black w-full",
                      children: H || "Add Account Name",
                    }),
                    l.jsx(M, {
                      className:
                        (((a = "") => fa(a).length >= 2)(H)
                          ? "text-green-500"
                          : "text-yellow-500") + " text-2xl ml-2",
                    }),
                    l.jsx(g, {
                      className: "text-black cursor-pointer ml-2 text-2xl",
                      onClick: () => ha("displayName"),
                    }),
                  ],
                }),
              ],
              ...
              children: [
                ...
                l.jsxs("div", {
                  className:
                    "flex items-center justify-between w-full px-4 py-3",
                  children: [
                    l.jsx(y, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-normal font-opensans text-black w-full",
                      children: t.email,
                    ...
                    l.jsx(M, {
                      className:
                        (t.email ? "text-green-500" : "text-yellow-500") +
                        " text-2xl ml-2",
                    }),
                  ],
                }),
              ...
              children: [
                ...
                l.jsxs("div", {
                  className:
                    "flex items-center justify-between w-full px-4 py-3",
                  children: [
                    l.jsx(A, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-opensans font-normal text-black w-full",
                      children: ca || "Add Phone Number",
                    }),
                    l.jsx(M, {
                      className:
                        (ca ? "text-green-500" : "text-yellow-500") +
                        " text-2xl ml-2",
                    }),
                    l.jsx(g, {
                      className: "text-black cursor-pointer ml-2 text-2xl",
                      onClick: () => ha("phoneNumber"),
                    }),
                  ],
                }),
              ],
            ...
            l.jsxs("div", {
              ...
              children: [
                l.jsx("h1", {
                  className:
                    "text-xs w-full translate-y-3 font-opensans translate-x-6 font-medium text-gray-500",
                  children: "Birthday",
                }),
                l.jsxs("div", {
                  className:
                    "flex items-center justify-between w-full px-4 py-3",
                  children: [
                    l.jsx(j, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-normal font-opensans text-black w-full",
                      children: ta || "Add Birthday",
                    }),
                    l.jsx(g, {
                      className: "text-black cursor-pointer ml-2 text-2xl",
                      onClick: () => ha("birthday"),
              ...
              children: [
                ...
                l.jsxs("div", {
                  className:
                    "flex items-center justify-between w-full px-4 py-3",
                  children: [
                    l.jsx(w, { className: "text-black text-xl mr-4" }),
                    l.jsx("p", {
                      className:
                        "text-sm font-normal font-opensans text-black w-full",
                      children: sa || "Add Delivery Address",
                    }),
                    l.jsx(M, {
                      className:
                        (sa ? "text-green-500" : "text-yellow-500") +
                        " text-2xl ml-2",
                    }),
                    l.jsx(g, {
                      className: "text-black cursor-pointer ml-2 text-2xl",
              ...
              children: [
                ...
                l.jsxs(
                  $.div,
                  {
                    ...
                    className:
                      "fixed bottom-0 z-[6000] left-0 right-0 h-[40vh] bg-white rounded-t-2xl shadow-xl flex flex-col",
                    children: [
                      l.jsx("button", {
                        onClick: () => F(!1),
                        className:
                          "absolute bg-gray-200 rounded-full p-1 top-4 right-4 text-gray-700 text-xl",
                        children: l.jsx(k, {}),
                      }),
                      l.jsxs("h2", {
                        className:
                          "mt-6 text-left ml-6 text-lg font-opensans font-medium",
                        children: [
                          "Edit",
                          " ",
                          "username" === W
                      ...
                      l.jsxs("div", {
                        className: "px-6 mt-4 overflow-y-auto flex-1",
                        children: [
                          "username" === W &&
                            l.jsx("input", {
                              type: "text",
                              value: V,
                              onChange: (a) => q(pa(a.target.value)),
                              className:
                                "w-full p-2 font-opensans border border-gray-200 bg-customSoftGray rounded",
                            }),
                          "displayName" === W &&
                            l.jsxs(l.Fragment, {
                              children: [
                                l.jsx("input", {
                                  ...
                                  className:
                                    "w-full p-2 border font-opensans border-gray-200 bg-customSoftGray rounded",
                                }),
                                l.jsx("input", {
                                  type: "text",
                                  value: K,
                                  onChange: (a) => aa(pa(a.target.value)),
                                  placeholder: "Last Name",
                                  className:
                                    "w-full p-2 mt-4 border font-opensans border-gray-200 bg-customSoftGray rounded",
                                }),
                              ],
                            }),
                          "phoneNumber" === W &&
                            l.jsxs(l.Fragment, {
                              children: [
                                l.jsxs("p", {
                                  className:
                                    "text-xs font-opensans text-gray-500 mb-2",
                                  children: [
                                    "Must be exactly 10 digits, no leading 0. E.g.",
                                    " ",
                                    l.jsx("code", { children: "8123456789" }),
                                  ],
                                }),
                                l.jsx("input", {
                                  type: "tel",
                                  value: ca,
                                  onChange: (a) => la(a.target.value),
                                  className:
                                    "w-full p-2 font-opensans border border-gray-200 bg-customSoftGray rounded",
                                }),
                              ],
                      ...
                      l.jsx("div", {
                        ...
                        children: l.jsx("button", {
                            ...
                            if (
                              "username" !== W || (V && !/[^a-zA-Z0-9]/.test(V))
                                ? "displayName" !== W ||
                                  ...
                                  ? "phoneNumber" !== W ||
                                    /^[1-9]\d{9}$/.test(ca) ||
                                    (s.error(
                                      "Phone number must be 10 digits and not start with 0. E.g. 8123456789",
                                    ),
                                    0)
                                  : (s.error(
                              ...
                              try {
                                ...
                                if ("username" === W) {
                                  ...
                                  (await U(R.currentUser, { displayName: c }),
                                    await r(i(n, "users", t.uid), {
                                      username: c,
                                    }),
                                    (a.username = c),
                                    q(c));
                                } else if ("displayName" === W) {
                                  const c = pa(X),
                                    l = `${c} ${pa(K)}`.trim();
                                  (await U(R.currentUser, { displayName: l }),
                                    await r(i(n, "users", t.uid), {
                                      displayName: l,
                                    }),
                                    (a.displayName = l),
                                    Y(l));
                                } else if ("phoneNumber" === W) {
                                  const c = `+234${ca}`;
                                  (await r(i(n, "users", t.uid), {
                                    phoneNumber: c,
                                  }),
                                  ...
                                  (await r(i(n, "users", t.uid), {
                                    address: sa,
                                    location: { lat: _.lat, lng: _.lng },
                                  }),
                                    (a.address = sa),
                                    (a.location = { lat: _.lat, lng: _.lng }),
                                    ra(sa));
                                } else
                                  "birthday" === W &&
                                    (await r(i(n, "users", t.uid), {
                          ...
                          disabled: ia,
                          className:
                            "w-full h-10 -translate-y-8 bg-customOrange text-white font-opensans font-medium rounded-full flex items-center justify-center",
                          children: ia
                            ? l.jsx(e, {
                                strokeColor: "white",
                                strokeWidth: "5",
  ...
  Fa = () => {
    ...
    (a.useEffect(() => {
      ...
      a.useEffect(() => {
        const a = "true" === new URLSearchParams(s.search).get("incomplete");
        if ((A(a), x(a), a)) {
          const a = setTimeout(() => x(!1), 1e4);
        ...
        (async () => {
          if (o && !f) {
            C(!0);
            try {
              const a = await E(i(n, "users", o.uid));
              a.exists() && d(va(a.data()));
            } catch (a) {
            } finally {
              C(!1);
            }
      ...
      a.useEffect(() => {
        ...
        const a = L(
          ...
          (a) => {
            var c;
            const l =
              (null == (c = a.data()) ? void 0 : c.profileComplete) ?? !1;
            (ga(l), d(Za({ profileComplete: l })));
          },
          (a) => {},
        );
        return () => a();
      }, [null == o ? void 0 : o.uid, d]));
    const { openChat: Aa } = G();
    return l.jsxs(l.Fragment, {
      children: [
        l.jsx(_, {
          ...
          description:
            "Update your personal information, view your orders, and more.",
          ...
          children: [
            v || j
              ...
              : l.jsxs("div", {
                  ...
                  children: [
                    l.jsxs("h1", {
                      className: "font-opensans text-xl font-semibold ",
                      children: [" ", "My Profile"],
                    }),
                    l.jsxs("div", {
                      className:
                        "flex border  rounded-full p-1 justify-center mt-4 relative",
                      children: [
                        k
                          ? l.jsx(O, { circle: !0, height: 120, width: 120 })
                          : f && f.photoURL
                            ? l.jsx("img", {
                                src: f.photoURL,
                                alt: "",
                                className:
                                  "rounded-full object-cover h-28 w-28",
                                onClick: () => {
                                  o && ma(!0);
                                },
                              })
                            : l.jsx("div", {
                                className:
                                  "rounded-full h-36 w-36 flex items-center justify-center",
                                onClick: () => {
                                  o && ma(!0);
                                },
                                children: l.jsx(pa, {
                        ...
                        o &&
                          l.jsx(T, {
                            className:
                              "absolute bottom-0 right-0 border text-black mr-2 text-3xl p-2 rounded-full bg-white cursor-pointer shadow-md",
                            onClick: () => ma(!0),
                          }),
                      ],
                    }),
                    l.jsx("p", {
                      className:
                        "text-lg font-semibold text-black font-opensans capitalize mt-2",
                      children: k
                        ? l.jsx(O, { width: 100 })
                        : null == f
                          ? void 0
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        l.jsx("div", {
                          ...
                          children: l.jsx("h1", {
                            className:
                              "text-base font-semibold mx-4 font-opensans translate-y-3 text-black",
                            children: "Account",
                          }),
                        }),
                        l.jsxs("div", {
                          ...
                          children: [
                            " ",
                            l.jsxs("div", {
                              className: `relative flex items-center justify-between w-full px-4 py-3 cursor-pointer border-none rounded-xl transition-all duration-500 ease-in-out ${h ? "highlight border-red-500 bg-red-100" : "bg-customGrey"} mb-3`,
                              onClick: () => Z(!0),
                              children: [
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("h2", {
                                      className:
                                        "text-size font-normal  text-sm  font-opensans text-black capitalize",
                                ...
                                y &&
                                  ...
                                  l.jsx("span", {
                                    className:
                                      "absolute top-1 right-4 font-opensans text-xs text-red-500 animate-pulse",
                        ...
                        l.jsx("div", {
                          ...
                          children: l.jsxs("div", {
                            className:
                              "flex items-center justify-between w-full px-4 py-3 cursor-pointer  border-none rounded-xl bg-customGrey mb-2",
                            onClick: () => t("/favorites"),
                            children: [
                              l.jsxs("div", {
                                ...
                                children: [
                                  l.jsx(I, {
                                    className: "text-red-500  text-xl mr-4",
                                  }),
                                  l.jsx("h2", {
                                    className:
                                      "text-size text-sm  font-normal font-opensans text-black capitalize",
                                    children: "Favorites",
                                  }),
                                ],
                              }),
                              l.jsx(xa, { className: "text-black" }),
                            ],
                          }),
                        }),
                      ],
                    ...
                    l.jsx("div", {
                      ...
                      children: l.jsx("h1", {
                        className:
                          "text-base font-opensans font-semibold mx-4 translate-y-3 text-black",
                        children: "Data",
                      }),
                    }),
                    l.jsxs("div", {
                      ...
                      children: [
                        l.jsxs("div", {
                          className:
                            "flex items-center justify-between w-full px-4 py-3 cursor-pointer border-none rounded-xl bg-customGrey mb-3",
                          onClick: () => t("/user-orders"),
                          children: [
                            l.jsxs("div", {
                              className: "flex items-center",
                              children: [
                                ...
                                l.jsx("h2", {
                                  className:
                                    "text-size font-normal font-opensans text-black capitalize",
                                  children: "Orders",
                                }),
                              ],
                            }),
                        ...
                        o &&
                          l.jsxs("div", {
                            className:
                              "flex items-center justify-between w-full px-3 py-3 cursor-pointer rounded-xl bg-customGrey mb-3",
                            onClick: () => {
                              if (!Ma)
                                return (
                                  sa.error(
                            ...
                            children: [
                              ...
                              l.jsx(xa, { className: "text-black mr-1" }),
                            ],
                          }),
                        o &&
                          l.jsxs("div", {
                            className:
                              "relative flex items-center justify-between w-full px-3 py-3 cursor-pointer rounded-xl bg-customGrey mb-3",
                            onClick: () => {
                              t("/offers");
                            },
                            children: [
                              l.jsxs("div", {
                                ...
                                children: [
                                  l.jsx(J, {
                                    className: "text-green-700 text-xl mr-4",
                                  }),
                                  l.jsxs("h2", {
                                    className:
                                      "text-size font-normal font-opensans text-black capitalize",
                                    children: [
                                      ...
                                      l.jsx("span", {
                                        className:
                                          "absolute -top-1 animate-pulse -right-10 text-[8px] font-bold text-white bg-customOrange px-2 py-0.5 rounded-md shadow-sm",
                                        children: "NEW",
                                      }),
                                    ],
                                  }),
                              ...
                              ba &&
                                l.jsx("span", {
                                  className:
                                    "absolute right-12 top-1/2 -translate-y-1/2 w-2.5 h-2.5 bg-customOrange rounded-full animate-pulse",
                                }),
                            ],
                          }),
                      ],
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        l.jsxs("div", {
                          className:
                            "relative flex items-center justify-between w-full px-4 py-3 cursor-not-allowed border-none rounded-xl bg-gray-100 mb-3 opacity-60",
                          children: [
                            l.jsxs("div", {
                              className: "flex items-center",
                              children: [
                                ...
                                l.jsx("h2", {
                                  className:
                                    "text-size font-normal text-sm  font-opensans text-gray-600 capitalize",
                                  children: "Donations",
                                }),
                              ],
                            }),
                            l.jsxs("div", {
                              ...
                              children: [
                                l.jsx(V, {
                                  className: "text-customOrange text-lg mr-2",
                                }),
                                l.jsx("span", {
                                  className:
                                    "text-customOrange font-semibold text-xs",
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        l.jsxs("div", {
                          className:
                            "flex items-center justify-between w-full px-4 py-3 cursor-pointer rounded-xl bg-customGrey mb-3",
                          onClick: () =>
                            window.open(
                        ...
                        l.jsxs("div", {
                          className: "w-full h-14 flex ml-4",
                          children: [
                            l.jsx("h1", {
                              className:
                                "text-base font-semibold mx-2 font-opensans translate-y-3 text-black",
                              children: "Beta",
                            }),
                            l.jsx(Q, {
                              className:
                                "font-semibold text-lg translate-y-[14px] text-black",
                            }),
                          ],
                        }),
                        l.jsx("div", {
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        o &&
                          l.jsx("div", {
                            className:
                              "flex flex-col items-center w-full cursor-pointer border-none rounded-xl bg-customGrey mb-3 px-2",
                            onClick: async () => {
                              var a;
                              try {
                                (U(!0),
                                  ...
                                  d(oa()),
                                  d({ type: "RESET_USER_DATA" }),
                                  d(da()),
                                  sa.success("Successfully logged out", {
                                    className: "custom-toast",
                                  }),
                                  t("/"));
                              } catch (c) {
                                sa.error("Error logging out", {
                                  className: "custom-toast",
                                });
                              } finally {
                                U(!1);
                            ...
                            children: l.jsxs("div", {
                              ...
                              children: [
                                ...
                                l.jsx("p", {
                                  className:
                                    "text-size text-black text-sm  font-opensans w-full font-normal",
                                  children: "Sign Out",
                                }),
                                z &&
                                  l.jsx(e, {
                        ...
                        !o &&
                          l.jsxs(l.Fragment, {
                            children: [
                              l.jsx("div", {
                                className:
                                  "flex flex-col items-center w-full cursor-pointer rounded-xl bg-customGrey mb-3 px-2",
                                onClick: () => g(!0),
                                children: l.jsxs("div", {
                                  className:
                                    "flex items-center justify-between w-full px-4 py-3",
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-black text-base font-opensans font-normal w-full",
                                      children: "Login",
                                    }),
                                  ],
                                }),
                              ...
                              l.jsx(ta, {
                                ...
                                openDisclaimer: (a) => (c) => {
                                  ...
                                  const l = `${window.location.origin}${a}`;
                                  (setDisclaimerUrl(l),
                                    setShowDisclaimerModal(!0));
                                },
                              }),
                            ],
                          }),
                        !o &&
                          l.jsx("div", {
                            ...
                            children: l.jsxs("div", {
                              ...
                              children: [
                                l.jsx(ea, {
                                  className: "text-customOrange text-xl mr-4",
                                }),
                                l.jsx("p", {
                                  className:
                                    "text-size text-black font-opensans w-full text-sm font-normal",
                    ...
                    l.jsx("div", {
                      ...
                      children: l.jsxs("p", {
                        className:
                          "text-sm font-poppins font-medium text-gray-500",
                        children: [" ", "v.2.8"],
                      }),
                    }),
                  ],
            ...
            ha &&
              l.jsx(Ua, {
                ...
                onRemoveAvatar: async () => {
                  try {
                    (await r(i(n, "users", o.uid), { photoURL: "" }),
                      d(Za({ photoURL: "" })),
                      sa.success("Avatar removed successfully", {
                        className: "custom-toast",
                      }));
                  } catch (a) {
                    sa.error("Error removing avatar. Please try again.", {
                      className: "custom-toast",
                    });
                  }
                },
