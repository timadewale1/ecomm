...
const Login = () => {
  ...
  const signIn = async (e) => {
    ...
    // Add a delay of 7 seconds before attempting to authenticate
                ...
                <Form className=" " onSubmit={signIn}>
                  <FormGroup className="relative w-full mt-4">
                    ...
                    <input
                      ...
                      value={email}
                      className="w-full h-11 bg-gray-300 border-none px-10 mb-1 font-semibold text- rounded-full"
                  ...
                  <FormGroup className="relative w-full">
                    ...
                    <input
                      ...
                      className="w-full h-11 border-none bg-gray-300 px-10 font-semibold text- rounded-full"
                  ...
                  <motion.button
                    whileTap={{ scale: 1.2 }}
                    type="submit"
                    className="glow-button w-full h-11 mt-7 bg-customOrange text-white font-semibold rounded-full"
                  >
                    Login
                  </motion.button>
