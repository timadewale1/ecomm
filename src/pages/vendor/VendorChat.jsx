...
export default function VendorChat() {
  ...
  const chatCustomerName =
    customerData?.displayName || customer?.username || "Customer";
  ...
  return (
    <>
      <SEO
        title={`Chat with ${chatCustomerName} – My Thrift`}
        description={`Continue your conversation with ${chatCustomerName} about "${product?.name}".`}
